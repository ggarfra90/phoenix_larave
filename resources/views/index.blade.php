...
<div class="row">
                        ...
                        <div class="chart-data-selector" id="salesSelectorWrapper">
                            ...
                            <div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
                                ...
                                <script>
                                    ...
                                    // See: src/javascripts/dashboard/examples.dashboard.js for more settings.
    ...
    <div class="col-md-6 col-lg-12 col-xl-6">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <div class="panel panel-featured-left panel-featured-secondary">
                    <div class="panel-body">
                        <div class="widget-summary">
                            <div class="widget-summary-col widget-summary-col-icon">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <div class="panel panel-featured-left panel-featured-tertiary">
                    <div class="panel-body">
                        <div class="widget-summary">
                            <div class="widget-summary-col widget-summary-col-icon">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <div class="panel panel-featured-left panel-featured-quartenary">
                    <div class="panel-body">
                        <div class="widget-summary">
                            <div class="widget-summary-col widget-summary-col-icon">
                    ...
                    <header class="panel-heading bg-primary">
                        ...
                        <div class="widget-profile-info">
                            <div class="profile-picture">
                                <img src="src/images/!logged-user.jpg">
                            </div>
                            ...
                            <li>
                                <div class="tm-box">
                                    ...
                                    <div class="thumbnail-gallery">
                                        <a class="img-thumbnail lightbox" href="src/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
                                            <img class="img-responsive" width="215" src="src/images/projects/project-4.jpg">
                                            <span class="zoom">
